                                        ...
                                        <div class="p-4">
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <a class="dropdown-item mb-2" href="../horizontal/crm-index"> CRM</a>
                                                    <a class="dropdown-item" href="../horizontal/projects-index"> Project</a>
                                                </div>
                                                <div class="col-6">
                                                    <a class="dropdown-item mb-2" href="../horizontal/ecommerce-index"> Ecommerce</a>
                                                    <a class="dropdown-item mb-2" href="../horizontal/helpdesk-index"> Helpdesk</a>
